...
def load_model_and_scaler():
    try:
        model = tf.keras.models.load_model('best_glcm_model.h5')
        scaler = joblib.load('scaler_glcm.pkl')
...
def detection_page(model, scaler, model_loaded):
    ...
    with col2:
        ...
        st.markdown("### 💡 Tips:")
        st.markdown("""
        - Gunakan gambar jalan yang jelas
        - Pastikan area yang ingin dideteksi terlihat
